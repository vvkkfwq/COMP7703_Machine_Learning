...
# Select only original sensor features (same as pca_testmode_sensor.py)
sensor_features = [
...
plt.title("PCA (Original Sensor Features) - Colored by Test Mode")
plt.xlabel("PC1")
plt.ylabel("PC2")
...
plt.savefig(os.path.join(output_dir, "pca_testmode_sensor_advanced.png"))
plt.close()
